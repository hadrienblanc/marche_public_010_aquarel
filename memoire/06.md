...
> - Objectif : qualifier et corriger les anomalies avec traçabilité, respect des délais, et non‑régression systématique.
> - Risques évités : corrections sans preuve, réouvertures, effets de bord sur la réplication/HD, backlog non maîtrisé.
> - Réponse du titulaire : ticketing horodaté, Definition of Done, RCA si nécessaire, tests NR et livraisons reproductibles.
> - Preuves : Annexe A.3 (rapport intervention), Annexe A.5 (RCA), Annexe A.11 (journal des corrections).
...
**Critères de clôture (Definition of Done)** : ces critères constituent un point de passage obligatoire. Un correctif n'est pas transmis comme « prêt à déployer » si un des éléments ci‑dessous est manquant. Un correctif est proposé à la clôture lorsque :
