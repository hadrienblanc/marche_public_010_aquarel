...
Dans ce cadre, le titulaire écarte volontairement (sauf besoin explicitement exprimé et arbitrage formalisé) :
- les refontes globales et réécritures « big bang » ;
- l'introduction de couches d'abstraction ou d'outillage sans valeur opérationnelle immédiate ;
- l'imposition d'un outil : le titulaire s'aligne sur l'outillage de suivi retenu par le SCV.
